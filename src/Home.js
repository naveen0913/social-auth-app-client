...
const Home = () => {
  ...
  const handleSave = () => {
    ...
    axios.post('https://social-auth-app-server.vercel.app/add',formData)
    .then((res)=>{
  ...
  const handleSubmit=async()=>{
    ...
    try{
      ...
      const response=await axios.post('https://social-auth-app-server.vercel.app/update-profile-picture', Imagedata);
